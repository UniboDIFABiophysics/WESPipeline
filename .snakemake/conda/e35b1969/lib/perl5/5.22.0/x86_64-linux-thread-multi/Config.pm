...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/perl5/5.22.0/x86_64-linux-thread-multi'),
    ...
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/5.22.0'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/perl5/site_perl/5.22.0/x86_64-linux-thread-multi'),
    sitelibexp => relocate_inc('.../../lib/perl5/site_perl/5.22.0'),
    so => 'so',
    useithreads => 'define',

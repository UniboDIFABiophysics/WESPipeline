...
if config['input_list_snakemake']:
    input_list = config['input_list_snakemake']
...
rule all:
    ...
    input:
        ...
        expand(trimmed_logs + '{sample}_settings.log.gz', sample=samples),
...
rule compress_trim_logs:
    ...
    output:
        ...
        log_settings = trimmed_logs + '{sample}_settings.log.gz',
    benchmark:
    ...
    shell:
        'gzip {input.log_disc} {input.log_stats} {input.log_singleton} {input.log_settings}'
